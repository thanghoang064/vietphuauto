    ...
    <div class="container" style="min-height: 578px">
        <div class="row">
            <div class="col-md-6 login-sec">
                ...
                <form class="login-form" method="POST" id="form--footer-info">
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"  name="name" class="validate form-control" placeholder="">
                        ...
                        <div class="form-group">
                            ...
                            <input class="validate form-control" name="phone" placeholder="0985323555">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password"  class="validate form-control" name="r_password" placeholder="******">
                ...
                <div class="copy-text">Bạn muốn đăng nhập <i class="fa fa-heart"></i><a
                        href="/dang-nhap">Bấm vô đây</a></div>
            </div>
