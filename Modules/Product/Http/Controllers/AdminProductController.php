...
class AdminProductController extends Controller
{
    ...
    {
        $product = $requestProduct->only(['pro_title_seo', 'pro_keyword_seo', 'pro_description_seo', 'pro_menu_id', 'pro_position', 'pro_name', 'pro_slug', 'pro_price_import', 'pro_price_repair', 'pro_description', 'pro_specifications', 'pro_content']);
        $productValue = $requestProduct->only(['designs', 'interior_color', 'engine_capacity', 'origin', 'fuel', 'year_of_manufacturing', 'gear', 'number_of_seats', 'went', 'drive', 'car_color', 'door_number']);
    ...
    {
        $productData = $requestProduct->only(['pro_title_seo', 'pro_keyword_seo', 'pro_description_seo', 'pro_menu_id', 'pro_position', 'pro_name', 'pro_slug', 'pro_price_import', 'pro_price', 'pro_price_repair', 'pro_description', 'pro_specifications', 'pro_content']);
