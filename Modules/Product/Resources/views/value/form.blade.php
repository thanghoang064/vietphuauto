            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="pro_title_seo" class="form-control max-length" maxlength="70" data-move="a_title" cols="30" rows="2" placeholder="Đồ gia dụng" autocomplete="off">{{ old('pro_title_seo',isset($product->pro_title_seo) ? $product->pro_title_seo : '') }}</textarea>
                ...
                <div class="card-body">
                    <h4>Ảnh đại diện / Tags sản phẩm</h4>

                    <div class="form-group ">
                        <div class="fs-13">
                            <label for="street">Tags sản phẩm <span class="text-danger">(*)</span></label>
                        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control pro_name" id="company" name="pro_name" value="{{ old('pro_name',isset($product->pro_name) ? $product->pro_name : '') }}" type="text" placeholder="VD : Đồ gia dụng vvv">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <div class="fs-13">
                                    <label for="company">Giá sản phẩm <span class="text-danger">(*)</span></label>
                                    <span class="float-right"><b>0</b>/70 ký tự</span>
                                </div>
                                <input class="form-control pro_name" id="company" name="pro_price" value="{{ old('pro_price',isset($product->pro_price) ? $product->pro_price : '') }}" type="text" placeholder="VD : Đồ gia dụng vvv">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <div class="fs-13">
                                    <label for="company">Loại sản phẩm <span class="text-danger">(*)</span></label>
                                    <span class="float-right"><b>0</b>/70 ký tự</span>
                                </div>
                                <select name="pro_type" class="form-control" id="">
                                    <option value="0" {{ old('pro_type', isset($product->pro_type) ? $product->pro_type : '') == 0 ?  "selected='selected'" : '' }}>__Sản phẩm thường__</option>
                                    <option value="1" {{ old('pro_type', isset($product->pro_type) ? $product->pro_type : '') == 1 ?  "selected='selected'" : '' }}>__Sản phẩm nổi bật__</option>
                                </select>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="pro_specifications" name="pro_specifications" type="text" placeholder="VD : Đồ gia dụng vvv">{!! old('pro_specifications',isset($product->pro_specifications) ? $product->pro_specifications : '') !!}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="pro_content" name="pro_content" type="text" placeholder="VD : Đồ gia dụng vvv">{!! old('pro_content',isset($product->pro_content) ? $product->pro_content : '') !!}</textarea>
