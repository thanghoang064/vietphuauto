            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control pro_name" required name="atr_name" value="{{ old('atr_name',isset($product->atr_name) ? $product->atr_name : '') }}" type="text" placeholder="VD : Đồ gia dụng vvv">
