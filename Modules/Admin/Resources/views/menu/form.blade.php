            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control max-length" maxlength="70" id="company" type="text" name="m_title_seo" value="{{ old('m_title_seo',isset($menu->m_title_seo) ? $menu->m_title_seo : '') }}" placeholder="Đồ gia dụng" autocomplete="off">
                    </div>
                    <div class="form-group">
                        <div class="fs-13">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="m_description_seo" class="form-control max-length" id="" cols="30" maxlength="160" rows="3" placeholder="Đồ gia dụng được sử dụng rộng rãi trên khắp thế giới, nó rất thân quen với con người" autocomplete="off">{{ old('m_description_seo',isset($menu->m_description_seo) ? $menu->m_description_seo : '') }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <select name="m_type_count" class="form-control" id="">
                            <option value="0" {{ old('m_type_count', isset($menu) ? $menu->m_type_count : '') == 0 ? "selected='selected'" : "" }}>Nhiều Sản Phẩm</option>
                            <option value="1" {{ old('m_type_count', isset($menu) ? $menu->m_type_count : '') == 1 ? "selected='selected'" : "" }}>1 Sản Phẩm</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <div class="fs-13">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control max-length component--create--url" id="company" maxlength="70"  name="m_title" value="{{ old('m_title',isset($menu->m_title) ? $menu->m_title : '') }}" type="text" placeholder="VD : Đồ gia dụng vvv">
