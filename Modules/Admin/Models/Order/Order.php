...
class Order extends Model
{
    ...
    protected $fillable = ['o_guest_id','o_product_id','o_menu_id','o_submit','o_status','o_messages','o_ip', 'car_viewing_day','cancel appointment','admin_id'];
    ...
    {
        return $this->belongsTo(Product::class,'o_product_id')->select('id', 'pro_name','pro_price');
    }
