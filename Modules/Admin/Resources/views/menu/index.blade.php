                                                    ...
                                                    <td>
                                                        <div class="box--action">
                                                            <div class="form-group">
                                                                <a href="{{ route('get.edit.menu',$menu->id) }}" class="btn btn-sm btn-outline-success p-0-10 ropdown-item"><i class="fa fa-edit"></i> Sửa</a>
                                                                <a data-type ='delete' href="{{ route('ajax.post.delete.menu',$menu->id) }}" class="ropdown-item btn btn-sm btn-outline-danger comfirm_delete_ajax p-0-10"><i class="fa fa-trash-o"></i> Xoá</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
