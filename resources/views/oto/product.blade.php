                                ...
                                <form action="" method="GET" )>
                                    <div class="col-md-3" style="padding-left: 0px !important;">
                                        <select name="pro_type" id="selector-product" style="height: 34px;padding: 0 !important;">
                                            ...
                                            <option value="0" @if(request('pro_type') == 0) selected @endif>__Sản phẩm thường__</option>
                                            <option value="1" @if(request('pro_type') == 1) selected @endif>__Sản phẩm nổi bật__</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3">
                            ...
                            <div class="row">
                                @foreach($products as $product)
                                    ...
                                    <div class="col-md-4 col-xs-6 product-item" style="margin-bottom: 10px;margin-left: 0;">
                                        ...
                                        <h3 class="product-title"><a href="{{ route('get.product.detail',[$product_slug,$product->id]) }}">{{ $product->pro_name }}</a></h3>
                                        <p class="product-price">Giá: {{ number_format($product->pro_price,0,',','.') }} VNĐ </p>
                                    </div>
                                @endforeach
