            ...
            <div class="row">
                <div class="col-sm-12 text-center">
                    <div style="width: 60%;margin:0 auto;padding: 20px">
                        <h1 style="text-transform: uppercase;font-size: 30px;font-weight: 600"><strong>{{ isset($information->if_meta_title) ? $information->if_meta_title : 'Đang cập nhật' }}</strong></h1>
                                    ...
                                    <div class="product-text">
                                        <div class="product-name">
                                            <h3 class="product-title">
                                                <a href="{{ route('get.product.detail',[$product_slug_h,$product->id]) }}" title="{{ $product->pro_name }}" class="color-setting">{{ $product->pro_name }}</a>
                                            </h3>
...
<section class="price-car">
    <div class="container">
        <h2 class="box-title" style="margin-top: 10px">
            <strong>Sản phẩm được xem nhiều nhất</strong>
        </h2>
        <div class="slider-car">
            <div class="our-product-gird tab-content">
                <div class="tab-pane fade in active">
                                                ...
                                                <div class="product-text">
                                                    <div class="product-name">
                                                        <h3 class="product-title product-title-2">
                                                            <a href="{{ route('get.product.detail',[$product_slug_mn,$product->id]) }}" title="{{ $product->pro_name }}" class="color-setting">{{ $product->pro_name }}</a>
                                                        </h3>
                                                        <div class="product-price-one">
