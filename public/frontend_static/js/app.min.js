...
var _extends = Object.assign || function (t) {
  ...
  function t(t, e, n) {
    ...
    var n = b && e.to_webp,
        r = o(t, e.data_src),
        a = o(t, e.data_bg);if (r) {
      var i = f(r, n);t.style.backgroundImage = 'url("' + i + '")';
    }if (a) {
      var s = f(a, n);t.style.backgroundImage = s;
    }
  },
      w = { IMG: function IMG(t, e) {
      var n = b && e.to_webp,
          r = e.data_srcset,
          a = t.parentNode;a && "PICTURE" === a.tagName && m(a, "srcset", r, n);var i = o(t, e.data_sizes);p(t, "sizes", i);var s = o(t, r);p(t, "srcset", s, n);var c = o(t, e.data_src);p(t, "src", c, n);
    }, IFRAME: function IFRAME(t, e) {
      var n = o(t, e.data_src);p(t, "src", n);
    }, VIDEO: function VIDEO(t, e) {
      var n = e.data_src,
          r = o(t, n);m(t, "src", n), p(t, "src", r), t.load();
    } },
      E = function E(t, e) {
    var n = e._settings,
        o = t.tagName,
        r = w[o];if (r) return r(t, n), e._updateLoadingCount(1), void (e._elements = u(e._elements, t));y(t, n);
  },
      I = function I(t, e) {
    ...
    var o = n._settings,
        ...
        i = t.target;L(i, o.class_loading), I(i, r), C(a, i), n._updateLoadingCount(-1);
  },
      N = function N(t, e) {
    var n = function n(r) {
      z(r, !0, e), A(t, n, o);
    ...
    t(e, o), n.unobserve(e);
      ...
      M = function M(t) {
    var e = c(t);e && (clearTimeout(e), s(t, null));
  },
      j = function j(t, e, n) {
    var o = n._settings.load_delay,
        r = c(t);r || (r = setTimeout(function () {
      S(t, e, n), M(t);
    }, o), s(t, r));
  },
      D = function D(t) {
    ...
    this._settings = n(t), this._setObserver(), this._loadingCount = 0, this.update(e);
  };return U.prototype = { _manageIntersection: function _manageIntersection(t) {
      var e = this._observer,
          n = this._settings.load_delay,
          o = t.target;n ? D(t) ? j(o, e, this) : M(o) : D(t) && S(o, e, this);
      ...
      var e = this,
          n = this._settings,
          o = t || n.container.querySelectorAll(n.elements_selector);this._elements = l(Array.prototype.slice.call(o)), !v && this._observer ? this._elements.forEach(function (t) {
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = messagesSwal;
...
;(function ($) {
    ...
    $.mad_core = {
        ...
        DOMLoaded: function DOMLoaded(options) {
        ...
        */
         ...
         **/
        hiddenSections: function hiddenSections(callback) {
        ...
        **/
        ...
        navInit: {
            ...
            touchNavEvent: function touchNavEvent(base) {
                var clicked = false;
            ...
            navProcess: function navProcess(base) {
            ...
            touchNav: function touchNav(base, target) {
            ...
            createResponsiveButtons: function createResponsiveButtons() {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__owl_carousel__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__owl_carousel___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__owl_carousel__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__library_lazyload_min__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__library_lazyload_min___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__library_lazyload_min__);



var Home = {
    init: function init() {
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.slider-car .owl-carousel').owlCarousel({
            autoplay: true,
            lazyLoad: true,
            loop: true,
            margin: 10,
...
__WEBPACK_IMPORTED_MODULE_0_jquery___default()(function () {
    ...
    (function () {
        ...
        var ll = new __WEBPACK_IMPORTED_MODULE_2__library_lazyload_min___default.a({
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__js_component_messages__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__owl_carousel__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__owl_carousel___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__owl_carousel__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__library_lazyload_min__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__library_lazyload_min___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__library_lazyload_min__);
...
var ProductDetail = {
    ...
    init: function init() {
        ...
        window.onscroll = function () {
            ...
            var height_main = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.main-height').height();

            var wScrollTop = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).scrollTop();

            if (wScrollTop >= height_main) {
                __WEBPACK_IMPORTED_MODULE_0_jquery___default()(".nav__product").hide();
            } else {
                __WEBPACK_IMPORTED_MODULE_0_jquery___default()(".nav__product").show();
            }
        };

        __this.showProduct();

        __WEBPACK_IMPORTED_MODULE_0_jquery___default()("#submit--info").click(function (event) {
            event.preventDefault();

            var $this = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this);

            var $input = $this.parents('#info__contact-form').find("input");

            var $flag = true;
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()(".errors").remove();
            __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.each($input, function (index, value) {
                if (__WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).val().length == 0) {
                    $flag = false;
                    __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).after('<span class="errors">Mời bạn điền thông tin</span>');
                }
            });

            if ($flag == true) {
                var $name = __WEBPACK_IMPORTED_MODULE_0_jquery___default()("#info__contact-form").find("input[name=name]").val();
                var $email = __WEBPACK_IMPORTED_MODULE_0_jquery___default()("#info__contact-form").find("input[name=email]").val();
                var $phone = __WEBPACK_IMPORTED_MODULE_0_jquery___default()("#info__contact-form").find("input[name=number]").val();
                var $message = __WEBPACK_IMPORTED_MODULE_0_jquery___default()("#info__contact-form").find("input[name=messages]").val();
                var $carDate = __WEBPACK_IMPORTED_MODULE_0_jquery___default()("#info__contact-form").find("input[name=date]").val();
                ...
                if ($name && $email && $phone && x >= y) {
                    ...
                    if ($url) {
                        __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.ajax({
                            ...
                            if (result) {
                                if (result.code == 1) {
                                    __WEBPACK_IMPORTED_MODULE_0_jquery___default()("#info__contact-form")[0].reset();
                                    $this.html($element);
                                    Object(__WEBPACK_IMPORTED_MODULE_1__js_component_messages__["a" /* messagesSwal */])('success', 'Cảm ơn bạn đã đăng ký xác nhận, chúng tôi sẽ sớm liên hệ với bạn');
                                } else if (result.code == 0) {
                                    Object(__WEBPACK_IMPORTED_MODULE_1__js_component_messages__["a" /* messagesSwal */])('warning', ' Email đã tồn tại ');
                                }
                            }
                        });
                    }
...
__WEBPACK_IMPORTED_MODULE_0_jquery___default()(function () {
    ...
    (function () {
        ...
        var ll = new __WEBPACK_IMPORTED_MODULE_3__library_lazyload_min___default.a({
            elements_selector: 'body .lazy',
            load_delay: 300,
            threshold: 0,
            callback_enter: function callback_enter(element) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_sweetalert2___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_sweetalert2__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__library_lazyload_min__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__library_lazyload_min___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__library_lazyload_min__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__helpers_browser__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__js_component_comment__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__helpers_loadCssJs__ = __webpack_require__(50);
...
var Init = {
    ...
    init: function init() {
        ...
        $("#top-form-search").click(function (event) {
            ...
            var $list_keyword = localStorage.getItem('keyword');
        });
    ...
    saveInfoFooter: function saveInfoFooter() {
        var __this = this;
        $("#success--footer").click(function (event) {
            ...
            if ($flag == true) {
                var $url = $this.attr('data-url');
                if ($url) {
                    var $name = $("#form--footer-info").find("input[name=name]").val();
                    var $email = $("#form--footer-info").find("input[name=email]").val();
                    var $phone = $("#form--footer-info").find("input[name=phone]").val();
                    var $product = $('#selector-product option:selected').val();
                    ...
                    if ($name, $phone, $email, $product) {
                        ...
                        $.ajax({
                            ...
                            if (result && result.code == 1) {
                                ...
                                Object(__WEBPACK_IMPORTED_MODULE_2__helpers_browser__["b" /* setCookie */])('popup', 1, 100);
    ...
    saveInfoPopup: function saveInfoPopup() {
        var __this = this;
        ...
        $("#save-info-guard").click(function (event) {
            ...
            if ($flag == true) {
                ...
                if ($url) {
                    var $name = $(".cookie-popup").find("input[name=name]").val();
                    var $email = $(".cookie-popup").find("input[name=email]").val();
                    var $phone = $(".cookie-popup").find("input[name=phone]").val();
                    var $messages = $(".cookie-popup").find("textarea[name=messages]").val();
    ...
    pupopInfo: function pupopInfo() {
        // check isset cookie
        if (!Object(__WEBPACK_IMPORTED_MODULE_2__helpers_browser__["a" /* checkCookie */])('popup')) {
            setTimeout(function () {
                $(".cookie-popup-wrap").fadeIn();
            }, 5000);
        }

        $('#closepopup').click(function () {
            $(this).parents('.cookie-popup-wrap').fadeOut();
            Object(__WEBPACK_IMPORTED_MODULE_2__helpers_browser__["b" /* setCookie */])('popup', 1, 50);
        });
    },

    lazyLoadingImage: function lazyLoadingImage() {
        (function () {
            function logElementEvent(eventName, element) {
                Date.now(), eventName, element.getAttribute("data-src");
            }

            var ll = new __WEBPACK_IMPORTED_MODULE_1__library_lazyload_min___default.a({
                elements_selector: 'body .lazy',
                load_delay: 150,
                threshold: 0,
                callback_enter: function callback_enter(element) {
    ...
    lazyLoadingCss: function lazyLoadingCss() {
        if (typeof HREF_CSS != 'undefined') {
            Object(__WEBPACK_IMPORTED_MODULE_4__helpers_loadCssJs__["a" /* loadCss */])(HREF_CSS);
        }
    }
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return checkCookie; });
function setCookie(cname, cvalue) {
    var hour = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 4;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__messages__ = __webpack_require__(6);
...
var Comment = {
  ...
  //     })
  // },
  cmt_submit: function cmt_submit(param) {
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()(document).on("submit", "#cmt_submit", function (e) {
      e.preventDefault();
      var data = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).serialize();
      console.log(data);
      var url = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).data("url");
      __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.ajax({
        type: "POST",
        url: url,
        data: data,
        ...
        success: function success(response) {
          Object(__WEBPACK_IMPORTED_MODULE_1__messages__["a" /* messagesSwal */])("success", " Cập nhật thành công");
          var $value = JSON.parse(response);
          __WEBPACK_IMPORTED_MODULE_0_jquery___default()(__this.configSelect.comments__list).prepend($value.data);
        }
      });
    });
  },
  showFromReply: function showFromReply() {
    var __this = this;
    ...
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()(document).ready(function () {
      __WEBPACK_IMPORTED_MODULE_0_jquery___default()(document).off().on("click", ".comment--reply", function (event) {
        event.preventDefault();
        var $this = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this);
        $this.after("\n                <div class=\"form--reply\" style=\"margin: 20px;\">\n                    <textarea name=\"\" style=\"height: 80px;margin-top: 20px\" id=\"\" cols=\"30\" rows=\"10\"></textarea>\n                    <button id=\"post--comment-reply\" style=\"padding: 5px 15px;background: #44c9de;color: white;margin: 10px;float: right;border-radius: 5px;\">G\u1EEDi</button>\n                </div>\n            ");
      });
  ...
  saveCommentReply: function saveCommentReply() {
    var __this = this;

    __WEBPACK_IMPORTED_MODULE_0_jquery___default()(document).ready(function () {
      __WEBPACK_IMPORTED_MODULE_0_jquery___default()(document).off("click").on("click", __this.configSelect.btn__submit_reply, function () {
        // $(__this.configSelect.btn__submit_reply).off().on('click', function (event) {
        event.preventDefault();

        console.log(1121212);

        var content = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(__this.configSelect.comment__reply).val();
        var url = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).attr("data-url");
        var id = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).attr("data-id");
        var type = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).attr("data-type");
        var parent = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).attr("data-parent");
        var $flag = true;
        if (content.length == 0) {
          $flag = false;
          __WEBPACK_IMPORTED_MODULE_0_jquery___default()(".error-comment").remove();
          __WEBPACK_IMPORTED_MODULE_0_jquery___default()(__this.configSelect.content).after('<p class="error-comment">Mời bạn nhập thông tin</p>');
        }
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return loadCss; });
