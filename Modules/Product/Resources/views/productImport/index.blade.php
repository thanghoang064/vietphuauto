                                            ...
                                            <form action="" class="form-horizontal">
                                                ...
                                                <div class="form-group col-sm-2" style="display: inline-block">
                                                    <select name="po" class="form-control" id="">
                                                        ...
                                                        <option value="2" {{ Request::query('po') == 2 ? "selected='selected'" : "" }}>Sidebar sản phẩm</option>
                                                    </select>
                                                </div>
                                        ...
                                        <table class="table table-responsive-sm">
                                            ...
                                            @forelse($products as $product)
                                                <tr data-id="{{ $product->id }}" >
                                                    ...
                                                    <td><span class="btn btn-sm btn-outline-success p-0-10">{{ $product->getPossion() }}</span></td>
                                                    <td>
                                                        <div class="box--action">
                                                            <div class="form-group">
                                                                ...
                                                                <a data-type ='delete' href="{{ route('ajax.post.delete.product',$product->id) }}" class="ropdown-item btn btn-sm btn-outline-danger comfirm_delete_ajax p-0-10"><i class="fa fa-trash-o"></i> Xoá</a>
                                                            </div>
                                                        </div>
