            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="a_title_seo" class="form-control max-length component--create--url" maxlength="70" data-move="a_title" cols="30" rows="2" placeholder="Đồ gia dụng" autocomplete="off">{{ old('a_title_seo',isset($article->a_title_seo) ? $article->a_title_seo : '') }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="a_keyword_seo" class="form-control max-length" maxlength="160"  cols="30" rows="5" placeholder="Đồ gia dụng, đồ gia dụng giá rẻ, thu mua đồ gia dụng" autocomplete="off">{{ old('a_keyword_seo',isset($article->a_keyword_seo) ? $article->a_keyword_seo : '') }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="a_description_seo" class="form-control max-length" data-move="a_description" maxlength="160" cols="30" rows="5" placeholder="Đồ gia dụng được sử dụng rộng rãi trên khắp thế giới, nó rất thân quen với con người" autocomplete="off">{{ old('a_description_seo',isset($article->a_description_seo) ? $article->a_description_seo : '') }}</textarea>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control a_title component--create--url" id="company" name="a_title" value="{{ old('a_title',isset($article->a_title) ? $article->a_title : '') }}" type="text" placeholder="VD : Đồ gia dụng vvv">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control a_description" id="company" name="a_description"  placeholder="VD : Đồ gia dụng được sử dụng rộng rãi ở Việt Nam, mà trên khắp toàn thế giới">{{ old('a_description',isset($article->a_description) ? $article->a_description : '') }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="a_content" name="a_content" type="text" placeholder="VD : Đồ gia dụng vvv">{!! old('a_content',isset($article->a_content) ? $article->a_content : '') !!}</textarea>
