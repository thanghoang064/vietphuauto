            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="pro_title_seo" class="form-control max-length component--create--url" maxlength="70" data-move="a_title" cols="30" rows="2" placeholder="Đồ gia dụng" autocomplete="off">{{ old('pro_title_seo',isset($product->pro_title_seo) ? $product->pro_title_seo : '') }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="pro_keyword_seo" class="form-control max-length" maxlength="160"  cols="30" rows="5" placeholder="Đồ gia dụng, đồ gia dụng giá rẻ, thu mua đồ gia dụng" autocomplete="off">{{ old('pro_keyword_seo',isset($product->pro_keyword_seo) ? $product->pro_keyword_seo : '') }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="pro_description_seo" class="form-control max-length" data-move="a_description" maxlength="160" cols="30" rows="5" placeholder="Đồ gia dụng được sử dụng rộng rãi trên khắp thế giới, nó rất thân quen với con người" autocomplete="off">{{ old('pro_description_seo',isset($product->pro_description_seo) ? $product->pro_description_seo : '') }}</textarea>
        ...
        <div class="col-sm-8">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <div class="fs-13">
                            <label for="company">Tên sản phẩm <span class="text-danger">(*)</span></label>
                            <span class="float-right"><b>0</b>/70 ký tự</span>
                        </div>
                        <input class="form-control pro_name component--create--url" id="company" name="pro_name" value="{{ old('pro_name',isset($product->pro_name) ? $product->pro_name : '') }}" type="text" placeholder="VD : Đồ gia dụng vvv">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <div class="fs-13">
                                    <label for="company">Giá nhập sản phẩm <span class="text-danger">(*)</span></label>
                                    <span class="float-right"><b>0</b>/70 ký tự</span>
                                </div>
                                @if(isset($product) && $product->pro_import == 0)
                                    <input class="form-control pro_name" id="company" name="pro_price_import" value="{{ old('pro_price_import',isset($product->pro_price_import) ? $product->pro_price_import : '') }}" type="number" placeholder="Giá sản phẩm">
                                @elseif(isset($product) && $product->pro_import == 1)
                                    <input class="form-control pro_name" disabled id="company" name="pro_price_import" value="{{ old('pro_price_import',isset($product->pro_price_import) ? $product->pro_price_import : '') }}" type="number" placeholder="Giá sản phẩm">
                                @else
                                    <input class="form-control pro_name"  id="company" name="pro_price_import" value="{{ old('pro_price_import',isset($product->pro_price_import) ? $product->pro_price_import : '') }}" type="number" placeholder="Giá sản phẩm">
                                @endif
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <div class="fs-13">
                                    <label for="company">Giá xuất sản phẩm<span class="text-danger"></span></label>
                                    <span class="float-right"><b>0</b>/70 ký tự</span>
                                </div>
                                @if(isset($product) && $product->pro_import == 0)
                                    <input class="form-control pro_name" id="company" disabled name="pro_price" value="{{ old('pro_price',isset($product->pro_price) ? $product->pro_price : '') }}" type="number" placeholder="Giá sản phẩm">
                                @elseif(isset($product) && $product->pro_import == 1)
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                @if(isset($product) && $product->pro_import == 0)
                                    <input class="form-control pro_name" id="company" name="pro_price_repair" value="{{ old('pro_price_repair',isset($product->pro_price_repair) ? $product->pro_price_repair : '') }}" type="number" placeholder="Giá sản phẩm">
                                @elseif(isset($product) && $product->pro_import == 1)
                                    <input class="form-control pro_name" disabled id="company" name="pro_price_repair" value="{{ old('pro_price_repair',isset($product->pro_price_repair) ? $product->pro_price_repair : '') }}" type="number" placeholder="Giá sản phẩm">
                                @else
                                    <input class="form-control pro_name" id="company" name="pro_price_repair" value="{{ old('pro_price_repair',isset($product->pro_price_repair) ? $product->pro_price_repair : '') }}" type="number" placeholder="Giá sản phẩm">
                                @endif
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control pro_description" id="company"  name="pro_description"  placeholder="VD : Đồ gia dụng được sử dụng rộng rãi ở Việt Nam, mà trên khắp toàn thế giới">{{ old('pro_description',isset($product->pro_description) ? $product->pro_description : '') }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="pro_specifications" name="pro_specifications" required type="text" placeholder="VD : Đồ gia dụng vvv">{!! old('pro_specifications',isset($product->pro_specifications) ? $product->pro_specifications : '') !!}</textarea>
                    ...
                    <div class="form-group">
                        <div class="fs-13">
                            <label for="company">Nội dung sản phẩm <span class="text-danger">(*)</span></label>
                        </div>
                        <textarea class="form-control" id="pro_content" required name="pro_content" type="text" placeholder="VD : Đồ gia dụng vvv">{!! old('pro_content',isset($product->pro_content) ? $product->pro_content : '') !!}</textarea>
