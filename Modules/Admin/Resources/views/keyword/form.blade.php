<form action="{{ route('post.create.keyword') }}" method="POST">
    ...
    <div class="form-group">
        ...
        <input class="form-control" id="company" type="text" name="k_name" value="{{ old('k_name',isset($menu->m_title_seo) ? $menu->m_title_seo : '') }}" placeholder="Đồ gia dụng" autocomplete="off">
